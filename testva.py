...
class VoiceAssistant(App):
    def build(self):
        ...
        #image widget
        self.window.add_widget(Image(source="va.zip"))
        
        #button widget to start
        self.button = Button(text = "START", 
                            ...
                            background_normal = "")
        self.button.bind(on_press=speak)
        ...
        #button widget to wish the user
        self.button = Button(text = "WISH ME", 
                            size_hint = (0.2, 0.2), 
                            padding = (20, 20), 
                            bold = True, 
                            background_color = "#30D5C8", 
                            background_normal = "")
        self.button.bind(on_press=wishme)
        self.window.add_widget(self.button)
...
if __name__== "__main__":
    ...
    while exit!=True:
        ...
        if 'wikipedia' in query:
           ...
           speak("What is the title of the notification?")
           tt = takecommand()
           ...
           d = takecommand()
           speak("number of hours")
           h = takecommand()
           speak("number of minutes")
           m = takecommand()
           speak("number of seconds")
           s = takecommand()
           t = (d * 86400) + (h * 3600) + m * 60 + s
           timer = Timer(cal_time, notifications)
           timer.start()
